...
#define V(name, fn) \
  ...
  V("labelLines", bare_gtk_label_lines)
  V("labelEllipsize", bare_gtk_label_ellipsize)
...
#define V(name, n) \
  ...
  V("ELLIPSIZE_NONE", PANGO_ELLIPSIZE_NONE)
  V("ELLIPSIZE_START", PANGO_ELLIPSIZE_START)
  V("ELLIPSIZE_MIDDLE", PANGO_ELLIPSIZE_MIDDLE)
  V("ELLIPSIZE_END", PANGO_ELLIPSIZE_END)
