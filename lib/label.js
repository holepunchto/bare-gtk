...
module.exports = exports = class GTKLabel extends GTKWidget {
  ...
  setMarkup(markup) {
    binding.labelSetMarkup(this._tag, markup)
  ...
  get lines() {
    return binding.labelLines(this._tag)
  }

  set lines(value) {
    binding.labelLines(this._tag, value)
  }

  get ellipsize() {
    return binding.labelEllipsize(this._tag)
  }

  set ellipsize(value) {
    binding.labelEllipsize(this._tag, value)
  }
}
