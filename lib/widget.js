...
const GDKCursor = require('./cursor')
...
module.exports = exports = class GTKWidget extends GObject {
  ...
  get cursor() {
    return wrap(GDKCursor, binding.widgetCursor(this._tag))
  }

  set cursor(value) {
    binding.widgetCursor(this._tag, value === null ? null : value._tag)
  }

  setCursorFromName(name) {
    binding.widgetSetCursorFromName(this._tag, name)
